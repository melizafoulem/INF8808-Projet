...
export class CirclePackingVisualization {
  ...
  renderAllFamilies() {
    ...
    // Pour chaque famille, on dessine un mini-chart
    const colorScale = d3
      .scaleOrdinal()
  ...
  goToNextPage() {
    const maxPage = Math.floor(
      this.fullOpeningFamilies.length / this.itemsPerPage
    );
